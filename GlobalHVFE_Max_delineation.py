...
def process_window(bounds, input_files, ref_transform):
    ...
    try:
        ...
        overlap_inundated = datasets['inundated_wetland'] & (
            datasets['surface_water']|stream_buffer
        )
        ...
        datasets['floodplain'][overlap_flood] = False
        
        overlap_flood = water_buffer & (
            datasets['floodplain']
        )
        water_buffer[overlap_flood] = False
        
        overlap_flood = wetland_buffer & (
            datasets['floodplain']
        )
        wetland_buffer[overlap_flood] = False
        
        overlap_flood = high_stream_buffer & (
            datasets['floodplain']
        )
        high_stream_buffer[overlap_flood] = False
        
        overlap_flood = datasets['low_stream'] & (
            datasets['floodplain']
        )
        datasets['low_stream'][overlap_flood] = False
        
        overlap_flood = datasets['high_stream'] & (
            datasets['floodplain']
        )
        datasets['high_stream'][overlap_flood] = False

        # Subcatchment overlaps
        overlap_subcatch = datasets['subcatch'] & (
            datasets['surface_water'] |datasets['inundated_wetland']|stream_buffer|datasets['floodplain']
        )
        ...
        overlap_buffer = water_buffer & (
            datasets['subcatch']|datasets['inundated_wetland']|datasets['surface_water']
        )
